...
#define GAMEPAD_BUTTON_LS     (1 << 8)   /* 左摇杆按键 */
#define GAMEPAD_BUTTON_RS     (1 << 9)   /* 右摇杆按键 */
#define GAMEPAD_BUTTON_10     (1 << 10)  /* 额外按钮10 */
#define GAMEPAD_BUTTON_11     (1 << 11)  /* 额外按钮11 */
#define GAMEPAD_BUTTON_12     (1 << 12)  /* 额外按钮12 */
#define GAMEPAD_BUTTON_13     (1 << 13)  /* 额外按钮13 */
#define GAMEPAD_BUTTON_14     (1 << 14)  /* 额外按钮14 */
#define GAMEPAD_BUTTON_15     (1 << 15)  /* 额外按钮15 */
